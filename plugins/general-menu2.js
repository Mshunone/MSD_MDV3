	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            orderTitle: 'Menu',
                            thumbnail: await (await fetch('https://telegra.ph/file/dbd61e3531c088f5b8161.jpg')).buffer(),
 ...
 *Tanggal ${date}*`
    ...
    const listMessage = {
      text: `мυʀѕι∂ вσт-χмℓ adalah bot whatsapp yang di bangun dengan Nodejs, dengan menggunakan server yang sangat kencang, tapi tidak terlalu kencang-kencang banget, yang dibangun oleh mursidxml.`.trim(),
      footer: wm,
      title: judul,
...
'jpegThumbnail': await(await fetch('https://telegra.ph/file/12787009289244d2cf3e5.jpg')).buffer(),
...
'sourceUrl':'https://www.facebook.com/profile.php?id=100015766658445&mibextid=ZbWKwL'}},
'caption': text,
'footer': hao,
...
conn.sendFile(m.chat, 'https://j.top4top.io/m_2552t036q0.mp3', '', null, m, true, { type: "audioMessage", ptt: false, seconds: 999999999 })
  } catch (e) {
